...
const Page = ({ navigation }: any) => {
  ...
  >([]);
  const onNext = () => {
    console.log("recipient locker: " + recipientAddress);
    parcelContext.setRecipientInfo({
      ...parcelContext.recipientInfo,
    ...
    <View style={styles.container}>
      ...
      {recipientAddress ? (
        <View style={styles.footer}>
          ...
          <View style={{ flexDirection: "column", gap: 4 }}>
            <View style={{ marginBottom: 4 }}>
              ...
              <Text style={{ fontSize: 16, fontFamily: "mon" }}>{recipientAddress}</Text>
            </View>
        ...
        <View style={styles.footer}>
          ...
          <View style={{ flexDirection: "column", gap: 4 }}>
            <View style={{ marginBottom: 4 }}>
              <Text style={{ fontSize: 16, fontFamily: "mon-b" }}>Recipient's locations</Text>
              <Text style={{ fontSize: 16, fontFamily: "mon" }}>{recipientAddress}</Text>
            </View>
            <TouchableOpacity style={[defaultStyles.btn, { opacity: 0.5 }]}>
              <Text style={defaultStyles.btnText}>Please choose your Home</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
...
function setGetoItems(arg0: any) {
